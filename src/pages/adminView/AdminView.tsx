...
export const AdminView = () => {
  ...
  return (
    <div className="px-4 md:px-8 flex flex-col gap-4 bg-[#f3f0eb] dark:bg-gray-900">
      <section>
        <h1 className="font-bold font-serif text-xl md:text-3xl flex justify-between items-center gap-2 dark:text-gray-300">
          Panel de Administración
          <span className="bg-white text-xs w-fit font-medium p-1 rounded-sm dark:bg-gray-700 px-2">
