...
export const Catalogo = () => {
  ...
  return (
    <section className="bg-[#f3f0eb] dark:bg-gray-900 text-black dark:text-gray-100 transition-colors duration-300 py-4 h-full px-8 md:px-20 flex flex-col gap-12">
      {/* Encabezado */}
