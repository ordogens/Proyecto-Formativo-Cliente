        ...
        <div className="flex flex-col gap-5 pt-2 md:gap-8 md:pt-10">
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            <section className="flex flex-col gap-2 md:gap-3">
              ...
              <button onClick={() => navigate("/personalizacion")} className="w-full border flex gap-2 justify-center border-red-300 text-red-400 hover:bg-red-500 hover:text-white transition duration-300 py-3 rounded-xl cursor-pointer">
                <Stars size={20} />
                <span>
                  Personalizar con IA
                </span>
