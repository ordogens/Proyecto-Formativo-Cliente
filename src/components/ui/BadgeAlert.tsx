...
export const BadgeAlert = ({ alertText }: Props) => {
  return (
    <div className="flex items-start sm:items-center p-4 mb-4 text-sm text-green-700 rounded-lg bg-green-200/40 border border-green-400 absolute bottom-1 right-5" role="alert">
