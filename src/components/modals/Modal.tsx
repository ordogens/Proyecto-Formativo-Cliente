...
export const Modal = ({ isOpen, onClose, children }: ModalProps) => {
  ...
  return (
    ...
    >
      <div
        className="relative bg-[#f3f0eb] dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300 p-6 rounded-2xl shadow-xl w-96 border border-red-500 dark:border-gray-700"
